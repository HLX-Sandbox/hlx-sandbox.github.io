...
function isCitaro(id) {
    let id2 = parseInt(id.split("|")[1])
    return (id2 > 800 && id2 < 900) || (id2 > 1799 && id2 < 1812)
}

function fetchVehicles() {
    fetch(CLOUDFLARED + "vehicles").then(r => r.json()).then(r => r.filter(a => isCitaro(a.id))).then(v => {
